...
socket.on('estado-actual', ( payload ) => {
     ...
     mostrarticket4.innerText = ticket1.numero;
     mostrarticket3.innerText = ticket2.numero;
     mostrarticket2.innerText = ticket3.numero;
     mostrarticket1.innerText = ticket4.numero;     
